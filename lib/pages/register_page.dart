    ...
    try {
      ...
      if(userCredential.user!.uid.toString().isNotEmpty){
        AppUser user = AppUser(
            uid: userCredential.user!.uid, name: nameController.text.trim(), email: loginIDController.text.trim()
        );
        var dataToSave = user.toMap();

        FirebaseFirestore.instance.collection("users").doc(user.uid).set(dataToSave).then((value) =>
                  ...
                  child: Container(
                      ...
                      child: Form(
                        ...
                        child: Column(
                          ...
                          children: [
                            Image.asset("assets/homaze.png", fit: BoxFit.fill),
                            SizedBox(height: 4,),
                            Text(
                              "Register Yourself",
                              style: TextStyle(
